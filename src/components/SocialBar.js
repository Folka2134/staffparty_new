          ...
          <div className="socialLink">
            ...
            >
              <svg
                ...
                data-prefix="fab"
                data-icon="instagram"
                className="svg-inline--fa fa-instagram fa-w-14 faPrimary faSecondary"
                role="img"
          ...
          <div className="socialLink">
            ...
            >
              <svg
                ...
                className="svg-inline--fa fa-facebook-f fa-w-10 faPrimary faSecondary"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 320 512"
              >
          ...
          <div className="socialLink">
            ...
            >
              <svg
                ...
                data-prefix="fab"
                data-icon="spotify"
                className="svg-inline--fa fa-spotify fa-w-16 faPrimary faSecondary test1"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 496 512"
              >
          ...
          <div className="socialLink">
            ...
            >
              <svg
                ...
                data-prefix="fab"
                data-icon="bandcamp"
                className="svg-inline--fa fa-bandcamp fa-w-16 faPrimary faSecondary test1"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 496 512"
              >
